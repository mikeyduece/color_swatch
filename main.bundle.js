...
var api = 'https://color-swatch-api.herokuapp.com/';
...
var topColor = function topColor() {
  $.get(api + 'api/v1/top_color', function (data) {
...
var postColors = function postColors(text, colorNames) {
  var matches = [];
